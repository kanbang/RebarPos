...
namespace OZOZ
{
    namespace RebarPosWrapper 
    {
		...
		public:
			...
			property Autodesk::AutoCAD::DatabaseServices::ObjectId^ NoteStyle { Autodesk::AutoCAD::DatabaseServices::ObjectId^ get(); void set(Autodesk::AutoCAD::DatabaseServices::ObjectId^ value); }
